...
<body>
  ...
  <div class="page-sheet">
    <div>
      ...
      <div class="clause-card">
        ...
        <ul class="legal-bullets">
          <li><strong>Cloudflare Inc. (Workers &amp; Edge):</strong> Global content distribution, TLS/SSL 256-bit encryption, bot protection, and DDoS defense.</li>
  ...
  <div class="page-sheet">
    <div>
      ...
      <div class="clause-card">
        ...
        <table class="cookie-table">
          ...
          <tbody>
            ...
            <tr>
              <td><code>google_maps_storage</code></td>
              <td>Third-Party / Functional</td>
              <td>Stores zoom level and map coordinates when viewing marina venue location.</td>
              <td>Session</td>
            </tr>
            <tr>
              <td><code>tripadvisor_widget</code></td>
              <td>Third-Party / Functional</td>
              <td>Provides direct access to verified guest traveler ratings and reviews.</td>
              <td>Session</td>
            </tr>
          </tbody>
        </table>
      ...
      <!-- Clause 3.4: Table QR Architecture -->
      <div class="clause-card">
        <div class="clause-head">
          <span class="clause-id">04.</span>
          <h3 class="clause-title">Contactless Table QR &amp; Digital Ordering Architecture</h3>
        </div>
        <p>
          Physical QR codes located on dining tables contain read-only encrypted URLs pointing directly to our authenticated digital menu. Scanning a table QR code does not install software or extract device data. It securely loads your assigned table session for streamlined ordering.
        </p>
      </div>
