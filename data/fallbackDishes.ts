...
export const ANTIPASTI: MenuItem[] = [
  {
    ...
    price: 15,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/TARTARE DI TONNO ALL ARANCIA.webp"
  },
  {
    ...
    price: 17,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/POLPO ALLA PIASTRA.webp"
  },
  {
    ...
    price: 15,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/TARTARE DI SALMONE AL MANGO.webp"
  },
  {
    id: "tris-di-crostini-con-pat-di-fegatini-pomodoro-e-basilico-pecorino-e-guanciale-4",
    italianName: "TRIS DI CROSTINI CON PAT├ë DI FEGATINI, POMODORO E BASILICO, PECORINO E GUANCIALE",
    tags: [],
    name: "Tuscan Crostini Trio",
    description: "Trio of crostini with liver p├ót├⌐, fresh tomato and basil, pecorino cheese and guanciale",
    price: 15,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/TRIS DI CROSTINI.webp"
  },
  {
    ...
    price: 29,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/GRAN TAGLIERE CASA ITALIA.webp"
  },
  {
    ...
    price: 11,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/PARMIGIANA DI MELAZANE.webp"
  },
  {
    ...
    price: 19,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/CARPACCIO DI MANZO.webp"
  },
  {
    ...
    price: 17,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/VITELLO TONNATO.webp"
  },
  {
    ...
    price: 17,
    category: "antipasti",
    image: "https://cdn.casaitaliarestaurants.com/menu/Appetizers/TARTARE DI MANZO.webp"
  }
];
...
export const PRIMI: MenuItem[] = [
  {
    ...
    price: 14,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/PENNE POMODORO.webp"
  },
  {
    ...
    description: "Rigatoni with bolognese rag├╣",
    price: 16,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/RIGATONI ALLA BOLOGNESE.webp"
  },
  {
    ...
    price: 18,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/SPAGHETTI ALLA CARBONARA.webp"
  },
  {
    ...
    price: 20,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/PENNE AL SALMONE.webp"
  },
  {
    ...
    price: 20,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/SPAGHETTI AL FRUTTI DI MARE.webp"
  },
  {
    ...
    price: 20,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/RISOTTO AL CROSTACEI E BURRATA.webp"
  },
  {
    ...
    price: 20,
    category: "primi",
    image: "https://cdn.casaitaliarestaurants.com/menu/pasta/RISOTTO AL TARUFO.webp"
  }
];
...
export const PASTA_FRESCA: MenuItem[] = [
  ...
  },
  {
    ...
    italianName: "LASAGNA AL RAG├Ö",
    tags: [],
    name: "Beef Lasagna",
    description: "Lasagna with meat sauce",
    price: 28,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/LASAGNA AL RAGU.webp"
  },
  {
    ...
    price: 15,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/GNOCCHI VERDI AGLI SPINACI.webp"
  },
  {
    id: "gnocchi-al-rag-20",
    italianName: "GNOCCHI AL RAG├Ö",
    tags: [],
    name: "Gnocchi with Meat Rag├╣",
    description: "Gnocchi with meat sauce",
    price: 16,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/GNOCCHI AL RAGU.webp"
  },
  {
    ...
    price: 16,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/RAVIOLI RIPIENI AL 4 FORMAGGI.webp"
  },
  {
    ...
    price: 18,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/RAVIOLI  RIPIENI AL SALMONE.webp"
  },
  {
    ...
    price: 17,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/RAVIOLI RIPIENI AL TARTUFO.webp"
  },
  {
    ...
    price: 15,
    category: "pasta_fresca",
    image: "https://cdn.casaitaliarestaurants.com/menu/fresh pasta/RAVIOLI RIPIENI RICOTTA E SPINACI.webp"
  }
];
...
export const SECONDI_CARNE: MenuItem[] = [
  {
    ...
    description: "Beef fillet with pepper sauce or mushrooms sauce served with baked potatoes and saut├¿ed vegetables",
    price: 24,
    category: "secondi_carne",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/FILETTO DI MANZO.webp"
  },
  {
  ...
  },
  {
    ...
    description: "Camel fillet with pepper sauce served with baked potatoes and saut├¿ed vegetables",
    price: 26,
    category: "secondi_carne",
    image: ""
  },
  {
    ...
    italianName: "POLLO AL LIMONE CON PUR├ê",
    tags: [],
    name: "Lemon Chicken with Mashed Potatoes",
    description: "Lemon chicken with mashed potatoes",
    price: 18,
    category: "secondi_carne",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/POLLO AL LIMONE.webp"
  },
  {
    id: "pollo-affumicato-con-salsa-di-peperoni-affumicati-servito-con-pur-29",
    italianName: "POLLO AFFUMICATO CON SALSA DI PEPERONI AFFUMICATI SERVITO CON PUR├ê",
    tags: [],
    ...
    price: 18,
    category: "secondi_carne",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/POLLO AFFUMICATO CON SALSA DI PEPERONI.webp"
  },
  {
    ...
    description: "Chicken pan├¿ served with green salad",
    price: 20,
    category: "secondi_carne",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/COTOLETTA DI POLLO.webp"
  },
  {
    ...
    description: "Veal pan├¿ served with rocket and parmesan scales",
    price: 22,
    category: "secondi_carne",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/COTOLETTA DI VITELLO.webp"
  }
];
...
export const SECONDI_PESCE: MenuItem[] = [
  {
    ...
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/FRITTO DIMARECON.webp"
  },
  {
    ...
    price: 24,
    category: "secondi_pesce",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/FILETTO DI SALMONE CON SALSA AL GAMBERI.webp"
  },
  {
    ...
    price: 26,
    category: "secondi_pesce",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/TAGLIATA DI TONNO.webp"
  },
  {
    ...
    price: 22,
    category: "secondi_pesce",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/FILETTO DI SALMONE AL FORNO.webp"
  },
  {
    ...
    price: 26,
    category: "secondi_pesce",
    image: "https://cdn.casaitaliarestaurants.com/menu/Main dishes/GAMBERI GRIGLIATI.webp"
  },
  {
...
export const CONTORNI: MenuItem[] = [
    ...
    name: "Grilled Vegetables", description: "Grilled vegetables", price: 5, category: "contorni", image: "" },
  {
    ...
    tags: [],
    name: "Saut├⌐ed Vegetables", description: "Sauteed vegetables", price: 5, category: "contorni", image: "" },
  {
    id: "insalata-40",
...
export const BURGERS: MenuItem[] = [
  ...
  },
  {
    ...
    price: 13,
    category: "burger",
    image: "https://cdn.casaitaliarestaurants.com/menu/Burger/VEGAN BURGER.webp"
  }
];
...
export const INSALATE: MenuItem[] = [
  {
    ...
    price: 12,
    category: "insalate",
    image: "https://cdn.casaitaliarestaurants.com/menu/Salad/TUNA SALAD.webp"
  },
  {
    id: "caesar-49",
    italianName: "CAESAR",
    ...
    price: 12,
    category: "insalate",
    image: "https://cdn.casaitaliarestaurants.com/menu/Salad/CAESAR SALAD.webp"
  },
  {
    id: "caprese-50",
    italianName: "CAPRESE",
    ...
    price: 15,
    category: "insalate",
    image: "https://cdn.casaitaliarestaurants.com/menu/Salad/CAPRESE.webp"
  },
  {
    ...
    price: 19,
    category: "insalate",
    image: "https://cdn.casaitaliarestaurants.com/menu/Salad/CRUDO E BUFALA.webp"
  }
];
...
export const PIZZE_ROSSE: MenuItem[] = [
  {
    ...
    tags: [],
    name: "Margherita Pizza", description: "Tomato sauce, mozzarella and basil", price: 9, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/MARGHERITA.webp" },
  {
    id: "marinara-53",
    italianName: "MARINARA",
    tags: [],
    name: "Marinara Pizza", description: "Tomato sauce, garlic and oregano", price: 7, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/MARINARA.webp" },
  {
    id: "tonno-e-cipolla-54",
    italianName: "TONNO E CIPOLLA",
    tags: [],
    name: "Tuna & Onion Pizza", description: "Tomato sauce, mozzarella, tuna and onions", price: 10, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/TONNO E CIPOLLA.webp" },
  {
    id: "napoli-55",
    italianName: "NAPOLI",
    tags: [],
    name: "Napoli Pizza", description: "Tomato sauce, mozzarella, anchovies, capers", price: 10, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/NAPOLI.webp" },
  {
    id: "crudo-rucola-e-grana-56",
    italianName: "CRUDO, RUCOLA E GRANA",
    tags: [],
    name: "Prosciutto, Arugula & Grana Pizza", description: "Tomato sauce, mozzarella, raw ham, rocket and parmesan flakes", price: 16, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/CRUDO RUCOLA E GRANA.webp" },
  {
    id: "bufalina-57",
    italianName: "BUFALINA",
    tags: [],
    name: "Buffalo Mozzarella Pizza", description: "Tomato sauce, buffalo mozzarella and basil", price: 14, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/BUFALINA.webp" },
  {
    id: "vegetariana-58",
    italianName: "VEGETARIANA",
    tags: [],
    name: "Vegetarian Pizza", description: "Tomato sauce, mozzarella and grilled vegetables", price: 12, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/VEGETARIANA.webp" },
  {
    id: "frutti-di-mare-59",
    italianName: "FRUTTI DI MARE",
    tags: [],
    name: "Seafood Pizza", description: "Tomato sauce, mozzarella and seafood", price: 15, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/FRUTTI DI MARE.webp" },
  {
    id: "salamino-60",
    italianName: "SALAMINO",
    tags: [],
    name: "Salami Pizza", description: "Tomato sauce, mozzarella and salami (pork salami OR cow salami)", price: 16, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/SALAMINO.webp" },
  {
    id: "calzone-port-ghalib-61",
    italianName: "CALZONE PORT GHALIB",
    tags: [],
    name: "Port Ghalib Calzone", description: "Tomato sauce, mozzarella, cooked ham", price: 12, category: "pizze_rosse", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/RED/CALZONE.webp" }
];
...
export const PIZZE_BIANCHE: MenuItem[] = [
  {
    ...
    tags: [],
    name: "Shrimp & Zucchini Pizza", description: "Mozzarella, shrimps and zucchinis", price: 14, category: "pizze_bianche", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/WHITE/GAMBERI E ZUCCHINE.webp" },
  {
    id: "mortadella-burrata-e-pistacchi-63",
    italianName: "MORTADELLA, BURRATA E PISTACCHI",
    tags: [],
    name: "Mortadella, Burrata & Pistachio Pizza", description: "Mozzarella, mortadella, burrata and pistachios", price: 18, category: "pizze_bianche", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/WHITE/MORTADELLA BURRATA E PISTACCHI.webp" },
  {
    id: "quattro-formaggi-64",
    italianName: "QUATTRO FORMAGGI",
    tags: [],
    name: "Four Cheese Pizza", description: "Four cheeses", price: 12, category: "pizze_bianche", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/WHITE/QUATTRO FORMAGGI.webp" },
  {
    ...
    name: "Arabic Bread with Salmon, Avocado & Cheese", description: "Salmon, avocado and cheese", price: 16, category: "pizze_bianche", image: "" },
  {
    ...
    tags: [],
    name: "Speck, Mascarpone & Walnut Pizza", description: "Speck, cheese and walnuts", price: 18, category: "pizze_bianche", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/WHITE/SPECK MASCARPONE E NOCI.webp" },
  {
    id: "tartufo-67",
    italianName: "TARTUFO",
    tags: [],
    name: "Truffle Pizza", description: "Mozzarella, truffle cream and truffle oil", price: 18, category: "pizze_bianche", image: "https://cdn.casaitaliarestaurants.com/menu/Pizza/WHITE/TARTUFO.webp" }
];

export const DOLCI: MenuItem[] = [
  {
    id: "tiramis-68",
    italianName: "TIRAMIS├Ö",
    tags: [],
    name: "Traditional Tiramis├╣", description: "Traditional Tiramis├╣", price: 7, category: "dolci", image: "" },
  {
...
export const VINI: MenuItem[] = [
  {
    ...
    tags: [],
    name: "Capebay White Wine", description: "Chardonnay (Glass: Γé¼6)", price: 30, category: "vini", image: "" },
  {
    id: "castello-di-trevi-white-99",
    italianName: "CASTELLO DI TREVI WHITE",
    tags: [],
    name: "Castello di Trevi White Wine", description: "Vermentino (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "chateau-de-granville-white-100",
    italianName: "CHATEAU DE GRANVILLE WHITE",
    tags: [],
    name: "Chateau de Granville White Wine", description: "Semillon (Glass: Γé¼8)", price: 40, category: "vini", image: "" },
  {
    id: "jardin-du-nil-white-101",
    italianName: "JARDIN DU NIL WHITE",
    tags: [],
    name: "Jardin du Nil White Wine", description: "Vermentino (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "grand-marquis-white-102",
    italianName: "GRAND MARQUIS WHITE",
    tags: [],
    name: "Grand Marquis White Wine", description: "Sultanine Blanche (Glass: Γé¼8)", price: 40, category: "vini", image: "" },
  {
    id: "chateau-byblos-white-103",
    italianName: "CHATEAU BYBLOS WHITE",
    tags: [],
    name: "Chateau Byblos White Wine", description: "Chardonnay, Sauvignon (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "capebay-red-104",
    italianName: "CAPEBAY RED",
    tags: [],
    name: "Capebay Red Wine", description: "Merlot (Glass: Γé¼6)", price: 30, category: "vini", image: "" },
  {
    id: "castello-di-trevi-red-105",
    italianName: "CASTELLO DI TREVI RED",
    tags: [],
    name: "Castello di Trevi Red Wine", description: "Merlot, Syrah (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "chateau-de-granville-red-106",
    italianName: "CHATEAU DE GRANVILLE RED",
    tags: [],
    name: "Chateau de Granville Red Wine", description: "Cabernet, Sauvignon (Glass: Γé¼8)", price: 40, category: "vini", image: "" },
  {
    id: "grand-marquis-red-107",
    italianName: "GRAND MARQUIS RED",
    tags: [],
    name: "Grand Marquis Red Wine", description: "Carignan, Syrah (Glass: Γé¼8)", price: 40, category: "vini", image: "" },
  {
    id: "jardin-du-nil-red-108",
    italianName: "JARDIN DU NIL RED",
    tags: [],
    name: "Jardin du Nil Red Wine", description: "Cabernet, Sauvignon, Syrah (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "castello-di-trevi-ros-109",
    italianName: "CASTELLO DI TREVI ROS├ë",
    tags: [],
    name: "Castello di Trevi Ros├⌐ Wine", description: "Ros├⌐ (Glass: Γé¼8)", price: 40, category: "vini", image: "" },
  {
    id: "le-baron-ros-110",
    italianName: "LE BARON ROS├ë",
    tags: [],
    name: "Le Baron Ros├⌐ Wine", description: "Sparkling Ros├⌐", price: 45, category: "vini", image: "" },
  {
  ...
  {
    id: "valmont-ros-112",
    italianName: "VALMONT ROS├ë",
    tags: [],
    name: "Valmont Ros├⌐ Wine", description: "Sparkling Ros├⌐ (Glass: Γé¼7)", price: 35, category: "vini", image: "" },
  {
    id: "valmont-white-113",
    italianName: "VALMONT WHITE",
    tags: [],
    name: "Valmont White Wine", description: "Sparkling White (Glass: Γé¼7)", price: 35, category: "vini", image: "" }
];
...
export const COCKTAILS: MenuItem[] = [
    ...
    name: "Mojito", description: "Light rum, lime wedge, fresh mint, soda", price: 10, category: "cocktails", image: "" },
  {
    ...
    tags: [],
    name: "Pi├▒a Colada", description: "Light rum, coconut milk, pineapple juice", price: 10, category: "cocktails", image: "" },
  {
    id: "mai-tai-126",
    italianName: "MAI TAI",
    tags: [],
    ...
    name: "Virgin Mojito", description: "Lime wedge, fresh mint, sprite, brown sugar", price: 7, category: "cocktails", image: "" },
  {
    ...
    tags: [],
    name: "Virgin Pi├▒a Colada", description: "Coconut milk, pineapple juice", price: 7, category: "cocktails", image: "" },
  {
